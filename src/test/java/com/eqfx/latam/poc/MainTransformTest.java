...
public class MainTransformTest {
    ...
    public void transformProductSuccessfullyOnTheSameYear() {
        ...
        PAssert.that(actualResult)
                .containsInAnyOrder(GenerateMockData.createQuarterProductMockObject(1, 1, 2013, 300),
                        GenerateMockData.createQuarterProductMockObject(1, 2, 2013, 600)
                );
    ...
    public void transformProductSuccessfullyOnDifferentYears() {
        ...
        PAssert.that(actualResult)
                .containsInAnyOrder(GenerateMockData.createQuarterProductMockObject(1, 1, 2013, 300),
                        GenerateMockData.createQuarterProductMockObject(1, 1, 2014, 900)
                );
        testPipeline.run().waitUntilFinish();
    }
     ...
     * objects with their correctly sum on their respectively year.
     */
    public void transformProductSuccessfullyOnDifferentYearsAndCategories() {
        PCollection<Product> products = testPipeline.apply("Create mock data", Create.of(
                GenerateMockData.createProductMockObject(1, 1, 2013, 2, 100.0, "Cat1.1"),
                GenerateMockData.createProductMockObject(1, 2, 2013, 1, 100.0, "Cat1.1"),
                GenerateMockData.createProductMockObject(2, 1, 2014, 3, 100.0, "Cat2.1"),
                GenerateMockData.createProductMockObject(2, 1, 2014, 2, 200.0, "Cat2.1"),
        ...
        PAssert.that(actualResult)
                .containsInAnyOrder(GenerateMockData.createQuarterProductMockObject(1, 1, 2013, 200),
                        GenerateMockData.createQuarterProductMockObject(1, 2, 2013, 100),
                        GenerateMockData.createQuarterProductMockObject(2, 1, 2014, 700),
                        GenerateMockData.createQuarterProductMockObject(2, 2, 2013, 200),
                        GenerateMockData.createQuarterProductMockObject(2, 2, 2014, 200)
                );
        testPipeline.run().waitUntilFinish();
    }
